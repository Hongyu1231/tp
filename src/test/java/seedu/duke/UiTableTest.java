...
public class UiTableTest {
    ...
    public void uiTableTest(){
        ...
        uiTable.addRow(new UiTableRow(new String[]{"1. STM32 Development Board","Total: 50","Available: 45","Loaned: 5"}));
        uiTable.addRow(new UiTableRow(new String[]{"2. Basys3 FPGA","Total: 20","Available: 20","Loaned: 0"}));
        uiTable.addRow(new UiTableRow(new String[]{"3. HDMI Cable","Total: 100","Available: <N/A>","Loaned: <N/A>"}));
